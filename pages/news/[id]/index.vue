            ...
            <div class="news-main__wrapper">
                <div class="news-main__left">
                    <template v-if="news && news.length > 0">
                        <NewsCard v-for="item in news" :key="item.id" :item="item" :category_id="category_id" />
                    </template>
                ...
                <div class="news-main__right">
                    <form class="news-main__search">
                        ...
                        <div class="news-main__search-input">
                            <input type="text" id="search" v-model="searchQuery" @input="handleSearch" :placeholder="$t('SearchPlaceholder')" />
                            <button type="submit">
...
const { id: category_id } = useRoute().params;
...
function handleSearch() {
    ...
    searchTimeout.value = setTimeout(() => {
        // Reset pagination and fetch first page with search
        currentPage.value = 1;
        fetchNews(1, false);
    }, 500);
}
...
useSeoMeta({
    ...
    ogImage: '/favicon.ico',
    ogUrl: `https://camu.edu/news/${category_id}`,
